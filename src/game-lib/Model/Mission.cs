...
{
    // kja pri:high currently this gets duplicated upon serialization, because MissionSites get serialized directly too.
    ...
    {
        // kja pri:high cannot use this assert here due to deserialization, but I should figure a way to use
