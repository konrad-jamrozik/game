module.exports = {
  ...
  ignorePatterns: ['dist', '.eslintrc.cjs'], // [vite template]
  parser: '@typescript-eslint/parser', // [vite template][ts-eslint]
  plugins: [ // [vite template]
    '@typescript-eslint', // [ts-eslint]
    'react-refresh' // [vite template][plugin: react-refresh]
  ],
  rules: { // [vite template][eslint rules]
    'react-refresh/only-export-components': [ // [vite template][plugin: react-refresh]
      'warn', // [vite template][plugin: react-refresh]
      { allowConstantExport: true }, // [vite template][plugin: react-refresh]
    ],
  },
  parserOptions: { // [vite template README][eslint parser options]
